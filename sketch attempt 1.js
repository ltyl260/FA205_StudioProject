...
function setup() {
  ...
  webcam.hide();
  webcam.loadPixels();
  firstImage = webcam.loadPixels();// store initial pixels
  let img = createImage(width,height); // new image to write these values to i guess
  img.loadpixels;
  img.set(firstImage);
  for (x = 0; x < 20; x++){
...
//   // https://editor.p5js.org/SoftwareArt/sketches/ucwDbDayt
//   // webcam.loadPixels();
//   // image(webcam,0,0,width, height);
